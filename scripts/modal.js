$(document).ready(function() {
  ...
  var modalText = {
    ...
    forex: {
      ...
      detail: 'About a hundred of forex robots written have given me experience and some money. My automated advisor was sold to people all over the world and helped them earn money as well. My robot "Double Extremum" took 8th place on mql5.com in 2018',
      link: '#'
    },
    melarossa: {
      title: 'Melarossa',
